        ...
        <div class="five columns">
           ...
           <div class="widget">
            ...
            <div class="status" >       
                ...
                <label style="font-weight: 300"><input type="checkbox" name="online" value="online" id="online" class="online"> Online</label>
...
xmlhttp.open('GET','/view-candidate/getuser?q='+category_list+'&skills='+skill+'&status='+online,true);
xmlhttp.send();
})
